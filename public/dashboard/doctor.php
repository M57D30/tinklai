    ...
    <div class="h-screen mt-6 ml-5 flex">
        ...
        <div class="ml-40">
            ...
            <div class="max-w-md bg-white p-6 rounded-3xl shadow-md  mt-6">
                <a href="">
                    <p class="text-2xl text-center">PACIENTAI</p>
                </a>
        ...
        <div class="ml-40 w-full ">
            <div class="max-w-md bg-white p-6 rounded-3xl shadow-md ">
                <h1 class="text-2xl font-bold mb-4">Naujausi pacientų rezultatai</h1>
                <div class="mb-4">
                    <p class="text-lg"><strong>Name:</strong> John</p>
                    <p class="text-lg"><strong>Lastname:</strong> Doe</p>
                ...
                <div class="flex justify-end">
                    <a href="/edit-profile"
                        class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Peržiūrėti</a>
                </div>
            </div>
            <div class="max-w-md bg-white p-6 rounded-3xl shadow-md  mt-6">
                <a href="">
                    <p class="text-2xl text-center">Tvarkaraštis</p>
                </a>
